...
imports = Imports(
	{
		...
		"Modals": "discum.interactions.modals"
	}
)
...
##########################################################
	...
	#click on modal and send data
	def clickModal(self, applicationID, channelID, guildID=None, nonce="calculate", data={}, sessionID="random"):
		return imports.Modals(self.discord, self.s, self.log).click(applicationID, channelID, guildID, nonce, data, sessionID)
